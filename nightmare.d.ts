...
// Source: https://raw.githubusercontent.com/ValeriyRadchenko/nightmare/7fe53470696371006ec1e743282bed0a80e4a1d0/nightmare.d.ts
declare module "nightmare" {
  ...
  class Nightmare {
    ...
    insert(selector: string, value: string): Nightmare;
